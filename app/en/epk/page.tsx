...
export default async function EpkPageEN() {
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div>
          ...
          <div className="mt-6 flex gap-3">
            ...
            <a href={`mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent('Project inquiry')}`} className="focus-ring inline-flex h-10 items-center justify-center rounded-md border border-border px-4 text-foreground">Contact</a>
          </div>
        </div>
