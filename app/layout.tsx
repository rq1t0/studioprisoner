  ...
  return (
    <html lang="ja" className={`dark ${jakarta.variable} ${zenKaku.variable}`}>
      <head>
        ...
        <link rel="preload" href="/images/hero.jpg" as="image" type="image/jpeg" fetchPriority="high" />
        <link rel="preload" href="/images/logo-white.png" as="image" type="image/png" fetchPriority="high" />
        <link rel="preload" href="/images/works/work-1.svg" as="image" type="image/svg+xml" />
